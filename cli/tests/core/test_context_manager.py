...
from skylock_cli.model.context import Context, Token
...
class TestContextManager(unittest.TestCase):
    ...
    @patch("skylock_cli.core.context_manager.ContextManager.context_file_path", Path("/tmp/test_skylock_config/test_skylock_config.json"))
