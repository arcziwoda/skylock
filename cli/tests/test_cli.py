...
class TestCLICommands(unittest.TestCase):
    ...
    @patch("skylock_cli.core.resource_operations.send_mkdir_request")
    ...
    def test_mkdir_invalid_path_error(self, mock_send):
        ...
        mock_send.side_effect = InvalidPathError("Invalid path")
    ...
    def test_mkdir_directory_missing_error(self, mock_send):
        ...
        mock_send.side_effect = DirectoryMissingError("/child_dir")
